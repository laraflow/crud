...
use Laraflow\ApiCrud\Contracts\ActivatorInterface;
use Laraflow\ApiCrud\FileRepository;
use Laraflow\ApiCrud\Generator;
use Laraflow\ApiCrud\Module;
...
class ModuleGenerator extends Generator
{
    ...
    public function generate(): int
    {
        ...
        $this->component->info("Creating laraflow: [$name]");
    ...
    public function generateResources()
    {
        if (GenerateConfigReader::read('seeder')->generate() === true) {
            $this->console->call('laraflow:make-seed', [
                'name' => $this->getName(),
                'module' => $this->getName(),
                '--master' => true,
            ]);
        ...
        if (GenerateConfigReader::read('provider')->generate() === true) {
            $this->console->call('laraflow:make-provider', [
                'name' => $this->getName().'ServiceProvider',
                'module' => $this->getName(),
                '--master' => true,
            ]);
            $this->console->call('laraflow:route-provider', [
                'module' => $this->getName(),
            ]);
        }
        ...
        if (GenerateConfigReader::read('controller')->generate() === true) {
            ...
            $this->console->call('laraflow:make-controller', [
