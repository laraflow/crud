...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/crud.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/crud)
...
```php
$crud = new Laraflow\Crud();
echo $crud->echoPhrase('Hello, Laraflow!');
```
